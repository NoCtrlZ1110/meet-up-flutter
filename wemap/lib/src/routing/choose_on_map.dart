  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(wemap_chooseOnMap, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w300)),
          elevation: 0.0,
          actions: <Widget>[
            MaterialButton(
              onPressed: () async {
                ...
                await widget.onChooseMap?.call(place);
                Navigator.of(context).pop();
              },
              child: Text(chooseText, style: TextStyle(color: primaryColor)),
            )
          ],
        ),
        body: Container(
            ...
            children: <Widget>[
              map = WeMap(
                initialCameraPosition:
                    CameraPosition(target: widget.searchLocation != null ? widget.searchLocation : LatLng(21.03, 105.787), zoom: 15.0),
