...
abstract class WeMapGlPlatform {
  /// The default instance of [WeMapGlPlatform] to use.
  ///
  /// Defaults to [MethodChannelWeMapGl].
  ///
  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [WeMapGlPlatform] when they register themselves.
  static WeMapGlPlatform Function() createInstance = () => MethodChannelWeMapGl();

  static Map<int, WeMapGlPlatform> _instances = {};

  static void addInstance(int id, WeMapGlPlatform platform) {
    _instances[id] = platform;
  }

  static WeMapGlPlatform? getInstance(int id) {
  ...
  final ArgumentCallbacks<MyLocationTrackingMode> onCameraTrackingChangedPlatform = ArgumentCallbacks<MyLocationTrackingMode>();
  ...
  Future<bool> addWMSLayer(String layerID, String wmsURL, int tileSize) async {
    throw UnimplementedError('addWMSLayer() has not been implemented.');
  }

  Future<bool> removeWMSLayer(String layerID) async {
    throw UnimplementedError('removeWMSLayer() has not been implemented.');
  }

  Future<bool> addTrafficLayer() async {
    throw UnimplementedError('addTrafficLayer() has not been implemented.');
  }

  Future<bool> removeTrafficLayer() async {
    throw UnimplementedError('removeTrafficLayer() has not been implemented.');
  }

  Future<bool> addSatelliteLayer() async {
    throw UnimplementedError('addSatelliteLayer() has not been implemented.');
  }

  Future<bool> removeSatelliteLayer() async {
    throw UnimplementedError('removeSatelliteLayer() has not been implemented.');
  }
}
